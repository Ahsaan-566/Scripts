...
dataset = pd.read_csv("/home/drogon/Desktop/Kaggle/train.csv", delimiter=',', encoding="latin-1")
...
li = ['id','comment_text']
labels = dataset.drop(li, axis=1)
corpus = dataset[['comment_text']]
print labels
print corpus
...
test_set = pd.read_csv("/home/drogon/Desktop/Kaggle/test.csv", delimiter=',',encoding='latin-1')
