...
list_df = df.take(100000)
df3 = sc.createDataFrame(list_df,schema=cSchema)
...
# eval = MulticlassClassificationEvaluator(predictionCol='predictions', labelCol='_c0', metricName='accuracy')
# final = eval.evaluate(test_results.prediction)
#print final